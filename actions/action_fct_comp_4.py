...
class AppFctComp4(QDialog):
    ...
    def refreshResult(self):
        # TODO 1.7 : fonction à modifier pour que le numéro de dossier ne puisse être choisi que parmi ceux présents
        #  dans la base et que la catégorie ne propose que des valeurs possibles pour le dossier choisi, une fois le
        #  fichier ui correspondant mis à jour
